...
3. Give the bot a handle (ex: `thr2005Bot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://thr2005.azurewebsites.net/api/messages`
