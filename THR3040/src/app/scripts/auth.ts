...
export class Auth {
  ...
  public performAuthV2(level: string) {
    ...
    const graphAPIScopes: string[] = ["https://graph.microsoft.com/user.read", "https://graph.microsoft.com/group.readwrite.all"];
    ...
    userAgentApplication.handleRedirectCallback(() => { const ww = "debug"; });
