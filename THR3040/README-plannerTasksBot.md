# Planner Tasks Bot - `plannerTasksBot`
...
3. Give the bot a handle (ex: `plannerTasksBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://thr3040.azurewebsites.net/api/messages`
